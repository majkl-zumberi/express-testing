...
export const actions = {
  ...
  create ({ bodymen }, res, next) {
    try {
      const obj = { ...(bodymen.body), id: uuid(), createdAt: moment().format('YYYY-MM-DD hh:mm:ss A Z') }
  ...
  update ({ params, bodymen }, res, next) {
    ...
    dataRes = { ...dataRes, ...(bodymen.body), updatedAt: moment().format('YYYY-MM-DD hh:mm:ss A Z') }
