...
export const actions = {
  ...
  create ({ bodymen }, res, next) {
    try {
      const obj = { ...(bodymen.body), id: uuid(), createdAt: moment().format("yyyy-MM-DD'T'HH:mm:ss.SSS'Z'") }
  ...
  update ({ params, bodymen }, res, next) {
    ...
    dataRes = { ...dataRes, ...(bodymen.body), updatedAt: moment().format("yyyy-MM-DD'T'HH:mm:ss.SSS'Z'") }
